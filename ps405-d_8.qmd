...
Today we are working with European Social Survey. You can access their documentation [here](https://ess.sikt.no/en/). We are interested in explaining why people trust or distrust each other. I have pre-processed the data for you. You can find how I did it [here](https://artur-baranov.github.io/nu-ps405-ds/ps405-d_8_extra.html).
...
Let's wrangle the data first. To ease the compheresnion, rename the variables.
...
Another important prerequisit is the normal distribution of errors (i.e., normality). Once again, we can use `plot()`. First, visualize plot without outliers.
