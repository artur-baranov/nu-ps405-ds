...
Let's analyze the regression. First, extract the residuals.

Explain to your friend why the residuals from a regression will always be un-correlated
with the predictor even if the zero conditional mean assumption is violated.
...
# cor.test(res, whr$Social_support)
# cor.test(res, yhat)
```
