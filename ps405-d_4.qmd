...
ggplot() +
  ...
  geom_vline(aes(color = "Known", xintercept = 0 + 1.96 * 1 / sqrt(100))) +
  geom_vline(aes(color = "Known", xintercept = 0 - 1.96 * 1 / sqrt(100))) +
  geom_vline(aes(color = "Calculated", xintercept = mean(x) + 1.96 * sd(x) / sqrt(100))) +
  geom_vline(aes(color = "Calculated", xintercept = mean(x) - 1.96 * sd(x) / sqrt(100))) +
  labs(color = "") +
  theme_bw()
```
...
Are these distribution different?
